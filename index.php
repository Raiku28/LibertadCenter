<html>
<head>
	<title>Libertad Main Center</title>
	<link rel="shortcut icon" type="image/x-icon" href="images/c1.jpg" />
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i> Libertad Main Health Center</h4></a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        ...
                        <h3>Welcome To The Main Health Center of Libertad</h3>
